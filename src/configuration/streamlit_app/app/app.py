...
from configuration.streamlit_app.app import documentation, ui
from configuration.streamlit_app.tabs.agent2D_tab import run_tab_agent2D
from configuration.streamlit_app.tabs.anthropometry_tab import run_tab_anthropometry
from configuration.streamlit_app.tabs.auto_crowd_creation_tab import run_tab_crowd
from configuration.streamlit_app.tabs.manual_crowd_creation_tab import run_tab_custom_crowd
from configuration.streamlit_app.tabs.pedestrian3D_tab import run_tab_pedestrian3D
from configuration.streamlit_app.utils.logging import setup_logging
