...
/// Name space for the TinyXML-2 library.
namespace tinyxml2
{
class XMLDocument;
class XMLElement;
...
class TINYXML2_LIB XMLElement : public XMLNode
{
    ...
    */
    ...
    XMLError QueryAttribute(const char* name, uint64_t* value) const { return QueryUnsigned64Attribute(name, value); }
    ...
    XMLError QueryAttribute(const char* name, const char** value) const { return QueryStringAttribute(name, value); }
...
class TINYXML2_LIB XMLDocument : public XMLNode
{
    ...
    */
    ...
    virtual XMLNode* ShallowClone(XMLDocument* /*document*/) const override { return 0; }
    virtual bool ShallowEqual(const XMLNode* /*compare*/) const override { return false; }
