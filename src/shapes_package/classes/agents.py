...
from src.shapes_package.classes.shapes2D import Shapes2D
from src.shapes_package.classes.shapes3D import Shapes3D
from src.shapes_package.utils import functions as fun
from src.shapes_package.utils.typing_custom import Sex, ShapeDataType, ShapeType
